...
#define OW_FLAG_PAUSE_TIME          TRUE  // If this flag is set and OW_USE_FAKE_RTC is enabled, seconds on the in-game clock will not advance.
#define OW_FLAG_NO_ENCOUNTER        TRUE  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      FALSE  // If this flag is set, trainers will not battle the player unless they're talked to.
