const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_MAY] = TRAINER_PIC_BRENDAN,
    [FACILITY_CLASS_MAY_2] = TRAINER_PIC_BRENDAN,
    [FACILITY_CLASS_MAY_3] = TRAINER_PIC_BRENDAN,
...
const u16 gTrainerPicToTrainerBackPic[] =
{
    ...
    [TRAINER_BACK_PIC_MAY] = TRAINER_PIC_BRENDAN,
