...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_QUESTIONFORFEITBATTLE]                = COMPOUND_STRING("Would you like to give up on this battle?"),
    [STRINGID_FORFEITBATTLEGAVEMONEY]               = COMPOUND_STRING("You got away safely..."),
...
const u8 gText_BattleMenu[] = _("Moves{CLEAR_TO 56}Info\nPrayers{CLEAR_TO 56}Retire");
